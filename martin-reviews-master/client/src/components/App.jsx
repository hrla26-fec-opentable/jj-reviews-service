...
class App extends Component {
  ...
  getAllReviews = () => {
    return Axios.get(`http://localhost:8001/api/reviews/all/${this.state.restaurantId}`) // change to include port #
      .then(({data}) => {
  ...
  getReviewsSummary = () => {
    return Axios.get(`http://localhost:8001/api/reviews/summary/${this.state.restaurantId}`)
      .then(({data}) => {
